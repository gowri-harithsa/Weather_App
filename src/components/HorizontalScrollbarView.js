          ...
          <ScrollView horizontal={true}>
            <View style={styles.bottomView}>
              <View style={styles.temperatureView}>
                <Image
                  source={require('../assets/images/temperatureInfo.png')}
                />
                <View style={styles.descriptionTextView}>
                  <Text style={styles.descriptionText}>Min - Max</Text>
                  <Text style={styles.textDegree}>22° - 34°</Text>
                </View>
              </View>
              <View style={styles.precipitationView}>
                <Image
                  source={require('../assets/images/precipitationInfo.png')}
                />
                <View style={styles.descriptionTextView}>
              ...
              <View style={styles.humidityView}>
                ...
                <View style={styles.descriptionTextView}>
                  ...
                  <Text style={styles.textDegree}>47%</Text>
                </View>
              </View>
            </View>
          </ScrollView>
